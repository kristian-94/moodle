...
$string['check_httpwebserver_actual_httpcode'] = 'Actual HTTP code';
$string['check_httpwebserver_actual_url'] = 'Actual redirected URL';
$string['check_httpwebserver_details_containederrors'] = 'The following tests contained errors';
$string['check_httpwebserver_details_correct'] = 'Redirects and URL\'s are loading as expected.';
$string['check_httpwebserver_error'] = 'Please check your web server configuration';
$string['check_httpwebserver_expected_httpcode'] = 'Expected HTTP code';
$string['check_httpwebserver_expected_url'] = 'Expected redirected URL';
$string['check_httpwebserver_name'] = 'HTTP web server configuration';
$string['check_httpwebserver_ok'] = 'HTTP/Webserver is correctly configured';
$string['check_httpwebserver_url_tried'] = 'URL requested';
